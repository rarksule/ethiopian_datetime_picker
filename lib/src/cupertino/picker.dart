...
///
/// {@tool dartpad}
/// This example shows a [CupertinoETPicker] that displays a list of fruits on a wheel for
/// selection.
///
...
class CupertinoETPicker extends StatefulWidget {
  ...
  ///
  /// The [selectionOverlay] widget drawn above the [CupertinoETPicker]'s picker
  /// wheel.
  /// It is vertically centered in the picker and is constrained to have the
  /// same height as the center row.
  ///
  /// If unspecified, it defaults to a [CupertinoETPickerDefaultSelectionOverlay]
...
class _CupertinoPickerState extends State<CupertinoETPicker> {
  ...
  @override
  void didUpdateWidget(CupertinoETPicker oldWidget) {
...
/// A default selection overlay for [CupertinoETPicker]s.
///
/// It draws a gray rounded rectangle to match the picker visuals introduced in
/// iOS 14.
///
/// This widget is typically only used in [CupertinoETPicker.selectionOverlay].
...
/// To achieve the same effect using [CupertinoETPickerDefaultSelectionOverlay],
...
/// [CupertinoETPicker]s (i.e., other "column"s).
///
/// See also:
///
///  * [CupertinoETPicker], which uses this widget as its default [CupertinoETPicker.selectionOverlay].
class CupertinoETPickerDefaultSelectionOverlay extends StatelessWidget {
  ...
  /// elsewhere) of a [CupertinoETPicker].
  ///
  ...
  const CupertinoETPickerDefaultSelectionOverlay({
    super.key,
  ...
  /// The color to fill in the background of the [CupertinoETPickerDefaultSelectionOverlay].
  /// It Support for use [CupertinoDynamicColor].
  ///
  /// Typically this should not be set to a fully opaque color, as the currently
  /// selected item of the underlying [CupertinoETPicker] should remain visible.
